...
class JobusModule extends Module
{
	public function init()
	{
		...
		defined('JOBUS_ID') or define('JOBUS_ID',$this->id);
	...
	*/
	...
	{
		return array(
            array('label'=>Yii::t('app','Jobus'), 'icon'=>'fa fa-puzzle-piece', 'url'=>array('#'), 'items'=>array(
			    array('label'=>Yii::t('app','Admin Jobus'), 'icon'=>'fa fa-list', 'url'=>array('/'.$this->id.'/mycontrollername/andactionname')),
