...
class ServicesModule extends Module
{
	public function init()
	{
		...
		defined('SERVICES_ID') or define('SERVICES_ID',$this->id);
	...
	*/
	...
	{
		return array(
            array('label'=>Yii::t('app','Services'), 'icon'=>'fa fa-puzzle-piece', 'url'=>array('#'), 'items'=>array(
			    array('label'=>Yii::t('app','Admin Services'), 'icon'=>'fa fa-list', 'url'=>array('/'.$this->id.'/mycontrollername/andactionname')),
