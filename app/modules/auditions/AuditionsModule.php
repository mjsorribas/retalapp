...
class AuditionsModule extends Module
{
	public function init()
	{
		...
		defined('AUDITIONS_ID') or define('AUDITIONS_ID',$this->id);
	...
	*/
	...
	{
		return array(
            array('label'=>Yii::t('app','Auditions'), 'icon'=>'fa fa-puzzle-piece', 'url'=>array('#'), 'items'=>array(
			    array('label'=>Yii::t('app','Admin Auditions'), 'icon'=>'fa fa-list', 'url'=>array('/'.$this->id.'/mycontrollername/andactionname')),
